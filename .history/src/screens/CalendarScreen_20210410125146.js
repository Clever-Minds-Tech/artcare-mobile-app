...
const lessMenstruationCalendarIcon = {key:'predmestruation', selectedDotColor: '#EEBCCD'}; //menstruação fluxo menor
const menstruationCalendarIcon = {key:'predmestruation', selectedDotColor: '#EEBCCD'}; //menstruação fluxo normal
