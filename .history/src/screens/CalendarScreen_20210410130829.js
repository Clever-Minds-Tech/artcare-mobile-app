...
const breastCalendarIcon = {key:'breast', src:"" , width:"", position:""}; //ícone da mama
const tpmCalendarIcon = {key:'tpm', color: '#EE9838'}; // raio tpm icon
const secretionCalendarIcon = {key:'secretion', color: '#67E3EF'}; // secreção
const heartCalendarIcon = {key:'heart', color: '#F0668C', src:"https://upload.wikimedia.org/wikipedia/commons/c/c8/Love_Heart_symbol.svg", width: 8, height: 8}; // relação sexual
...
const spottedCalendarIcon = {key:'spotted', color:"transparent", selectedDotColor: '#E290AB'}; //menstruação fluxo normal
