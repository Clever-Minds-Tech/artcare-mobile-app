...
const heartCalendarIcon = { key: 'heart', color: '#F0668C', width: 8, height: 8 , margin:1}; //source={ //require('https://upload.wikimedia.org/wikipedia/commons/c/c8/Love_Heart_symbol.svg') } }; // relação sexual
