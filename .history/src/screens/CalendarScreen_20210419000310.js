...
const breastCalendarIcon = { key: 'breast', src: "", width: 10, height: 8, position: "" }; //ícone da mama
...
const tpmCalendarIcon = { key: 'tpm', color: '#EE9838', width: 10, height: 8 }; // raio tpm icon
const tpmcolor = '#EE9838';
const secretionCalendarIcon = { key: 'secretion', color: '#67E3EF', width: 10, height: 10 }; // secreção
const heartCalendarIcon = { key: 'heart', color: '#F0668C', width: 10, height: 8 }; //source={ //require('https://upload.wikimedia.org/wikipedia/commons/c/c8/Love_Heart_symbol.svg') } }; // relação sexual
...
const spottedCalendarIcon = { key: 'spotted', color: "transparent", selectedDotColor: '#E290AB', width: 10, height: 8, }; //menstruação fluxo normal
